...
export default function ApparelLogosPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="flex max-w-6xl mx-auto px-8 pt-32 pb-24 gap-12">
        
        {/* Sticky Side Navigation */}
        <nav className="hidden lg:block sticky top-32 self-start w-48 flex-shrink-0">
          <p className="text-[0.6rem] tracking-[0.2em] uppercase text-[#7742b8] font-semibold mb-4">
            Jump to
          </p>
          <ul className="space-y-2">
            ...
            <li>
              <a 
                href="#overview" 
                className="text-[0.75rem] text-[#666] hover:text-[#7742b8] transition-colors duration-200 block py-1 border-l-2 border-transparent hover:border-[#7742b8] pl-3"
              >
                Overview
              </a>
            </li>
            ...
            <li>
              ...
              <ul className="ml-4 mt-1 space-y-1">
                <li>
                  <a 
                    href="#l1" 
                    className="text-[0.7rem] text-[#999] hover:text-[#7742b8] transition-colors duration-200 block py-0.5 border-l-2 border-transparent hover:border-[#7742b8] pl-3"
                  >
                    Fonzo's Taco
                  </a>
                </li>
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Header */}
          <div id="overview" className="reveal mb-16 scroll-mt-32">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#e0e0e0] mb-20">
            {[
              ...
              { label: 'Tools', value: 'Illustrator · Photoshop · Canva' },
          ...
          {/* Divider label — Logos */}
          <div id="logo-design" className="flex items-center gap-4 mb-8 scroll-mt-32">
          ...
          <div id="l1" className="mb-16 scroll-mt-32">
          ...
          <div id="apparel-design" className="flex items-center gap-4 mb-8 scroll-mt-32">
            <div className="flex-1 h-px bg-[#e0e0e0]" />
          ...
          {/* s1 — 457 Tailoring */}
          <div id="s1" className="mb-10 scroll-mt-32">
            <div className="overflow-hidden rounded-2xl border border-[#e0e0e0]">
              <img
          ...
          {/* s2 — NSED 2026 Shirt */}
          <div id="s2" className="mb-10 scroll-mt-32">
            <div className="overflow-hidden rounded-2xl border border-[#e0e0e0]">
              <img
          ...
          <div id="s3" className="mb-10 scroll-mt-32">
            <div className="overflow-hidden rounded-2xl border border-[#e0e0e0]">
              <img
          ...
          <div id="event-design" className="flex items-center gap-4 mb-8 scroll-mt-32">
            <div className="flex-1 h-px bg-[#e0e0e0]" />
          ...
          {/* e1 — Event Design */}
          <div id="e1" className="mb-20 scroll-mt-32">
            <div className="overflow-hidden rounded-2xl border border-[#e0e0e0]">
              <img
